                                                   ...
                                                   <div class="form-label">Տեղադրել նաև սլայդերում ?</div>
                                                    <div class="custom-controls-stacked">
                                                        <label class="custom-control custom-radio">
                                                            <input type="radio" class="custom-control-input" name="radios" value="yes" checked>
                                                            <span class="custom-control-label">Այո</span>
                                                        </label>
                                                        <label class="custom-control custom-radio">
                                                            <input type="radio" class="custom-control-input" name="radios" value="no">
                                                            <span class="custom-control-label">Ոչ</span>
                                                        </label>
                                                    </div>
                                                </div>-->

                                                <input type="hidden" name="radios" value="yes">
